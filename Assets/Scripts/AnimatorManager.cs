...
public class AnimatorManager : MonoBehaviour
{
    ...
    public void UpdateAnimatorValues(float horizontalMovement, float verticalMovement, bool isSprinting, bool isLockedOn = false)
    {
    ...
    private void OnAnimatorMove()
    {
        if (playerManager.isUsingRootMotion)
        {
            ...
            deltaPosition.y = 0;
            Vector3 velocity = deltaPosition * 2 / Time.deltaTime;
