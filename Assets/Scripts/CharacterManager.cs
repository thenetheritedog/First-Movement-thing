...
public class CharacterManager : MonoBehaviour
{
    ...
    public ParticleSystem dropParticlesInstance;
    ...
    public string[] droppedItemPossibility;
    public int droppedItemLevelMin;
    public int droppedItemLevelMax;
    public int droppedItemQuantityMin;
    public int droppedItemQuantityMax;
    public int amountOfItemsDropped;
    public int amountOfWeaponsDropped;
